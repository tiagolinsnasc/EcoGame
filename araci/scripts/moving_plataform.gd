...
func move_plataform():
	...
	plataform_tween.tween_property(self,"follow",move_direction, duration).set_delay(WAIT_DURATION)#Repete o tween indefinidamente
	plataform_tween.tween_property(self,"follow",Vector2.ZERO, duration).set_delay(WAIT_DURATION*2.0)
